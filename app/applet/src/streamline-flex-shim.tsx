...
export const Home = c(["M12 2.5L2 10.5H5V21.5H11V16.5H13V21.5H19V10.5H22L12 2.5Z"]);
...
export const MessageCircle = c(["M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"]);
export const MessageSquare = c(["M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"]);
...
export const ShoppingBag = c(["M4 8h16v13H4V8z", "M8 8V6a4 4 0 0 1 8 0v2"]);
export const ShoppingCart = c(["M3 3h2l2 11h12l2-7H8", "M9 22a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3zm8 0a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3z"]);
