  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex w-full flex-col min-h-[calc(100vh-56px)]">
        {/* Main Content Area */}
        <div className={`transition-all duration-300 flex-1 w-full max-w-full ${sidebarOpen ? 'md:pl-72' : ''} lg:max-w-[calc(100vw-80px)] xl:max-w-none bg-transparent`}>
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto no-scrollbar space-y-4 pr-1">
               {(function() {
                 ...
                 <div key={item.id || `cart-${idx}`} className="flex items-center space-x-4 bg-zinc-50 dark:bg-zinc-800 p-3 rounded-2xl border border-zinc-100 dark:border-zinc-800 hover:border-zinc-300 transition-colors">
