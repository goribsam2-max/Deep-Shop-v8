          ...
          <div className="space-y-0 divide-y divide-dashed divide-border -mx-4 sm:mx-0">
            {loading ? (
              ...
              <div className="flex flex-col items-center justify-center space-y-2.5 py-16 text-center">
                {illustrations.emptyNotifications ? (
                  <div className="w-48 h-48 mx-auto mb-2 rounded-[20px] overflow-hidden">
                    <img src={illustrations.emptyNotifications} alt="No Notifications" className="w-full h-full object-cover" />
                  </div>
                ) : (
