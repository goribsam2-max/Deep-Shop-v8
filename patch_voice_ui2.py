...
start_str = '<div className="flex items-center gap-3 w-full bg-zinc-50 dark:bg-[#0a0a0a] pt-2">'
end_str = '</button>\n                    </div>'
...
if start_idx != -1 and end_idx != -1:
    old_section = content[start_idx : end_idx + len(end_str)]
    
    replacement = """<div className="flex items-center gap-3 w-full bg-zinc-50 dark:bg-[#0a0a0a] pt-2 relative">
